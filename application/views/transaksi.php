        ...
        <div class="row">
          <div class="col-sm-3">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" placeholder="Diskon" id="grosir_barang" value="0">
            </div>
            <div class="form-group">
          ...
          <div class="col-sm-3">
            ...
            <div class="form-group">
              <label>Sisa</label>
              <input type="text" class="form-control" placeholder="Sisa" id="sisa_produk" disabled>
            </div>
            <input type="text" class="form-control" id="hrga" hidden>
            <input type="text" class="form-control" id="stk" hidden>
            <div class="form-group">
              <label>Minimal Grosir</label>
              <input type="text" class="form-control" placeholder="Minimal Grosir" id="minimal_grosir" disabled>
            </div>
            <div class="form-group">
              <label>Harga Grosir</label>
              <input type="text" class="form-control" placeholder="Harga Grosir" id="harga_grosir" disabled>
            </div>
          </div>
