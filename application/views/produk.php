  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Harga Grosir" name="harga_grosir" required>
      </div>
      <div class="form-group">
        <label>Minimal Grosir</label>
        <input type="text" class="form-control" placeholder="Jumlah Minimal" name="minimal_grosir" required>
      </div>
      <div class="form-group">
        <label>Stok</label>
